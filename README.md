...
forge script script/MyERC20.s.sol:ERC20Script --rpc-url local --broadcast
...
## 部署Exchange
forge script script/Exchange.s.sol:ExchangeScript --broadcast
